            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=products">Our Products</a></li>
                    ...
                    <?php if($_settings->userdata('id') != '' && $_settings->userdata('login_type') == 2): ?>
                      <div class="btn-group nav-link">
                        ...
                        <div class="dropdown-menu" role="menu">
                          ...
                          <a class="dropdown-item" href="<?php echo base_url.'?p=donation' ?>"><span class="fa fa-dollar-sign"></span> Donation</a>
                          <div class="dropdown-divider"></div>
